                ...
                <li key={faq.q}>
                  <h3>
                    <button
                      ...
                      className="flex w-full items-start justify-between gap-6 py-5 text-left transition-colors hover:text-accent-dark"
                    >
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen ? (
                      ...
                      >
                        <p className="max-w-2xl pb-6 pr-10 text-[0.95rem] leading-relaxed text-ink-soft">
                          {faq.a}
                        </p>
                      </motion.div>
                    ) : null}
